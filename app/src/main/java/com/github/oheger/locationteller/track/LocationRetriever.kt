...
/**
 * A helper class that implements the functionality to retrieve the current
 * GPS location from the corresponding system service.
 *
 * The class requests an update of the GPS location and waits for a
 * configurable timeout for a response. This is of course done without blocking
 * the main thread. The location that was retrieved (which can be *null*) is
